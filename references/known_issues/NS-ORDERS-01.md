---
type: Reference
title: NS-ORDERS-01 — `sales` measured, deliberately not served — it is the served order line delivered a second time
...
**Resolution.** resolved —  (transforms: v_contoso_order_line)
